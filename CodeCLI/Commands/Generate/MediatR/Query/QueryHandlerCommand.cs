...
[Command("generate mediatr query-handler", "(generate|g) (mediatr|m) (query-handler|qh)$", Description = "Creates a new, generic request query handler definition using MediatR in the given project.")]
