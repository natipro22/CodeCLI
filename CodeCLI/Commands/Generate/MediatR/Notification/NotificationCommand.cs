...
[Command("generate(g) mediatr(m) notification(n)", @"^\b(generate|g)\b \b(mediatr|m)\b \b(notification|n)\b$", Description = "Creates a new, generic event notification definition using MediatR in the given project.")]
