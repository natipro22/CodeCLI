...
[Command("generate(g) mediatr(m) command(c)", @"^\b(generate|g)\b \b(mediatr|m)\b \b(command|c)\b$", Description = "Creates a new, generic CQRS command definition using MediatR in the given project.")]
